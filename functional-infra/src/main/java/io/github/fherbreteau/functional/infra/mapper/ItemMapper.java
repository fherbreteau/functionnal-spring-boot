...
public class ItemMapper implements RowMapper<Item> {
    ...
    public Item mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        builder.withName(rs.getString(COL_NAME))
                ...
                .withOwnerAccess(itemFinder.getAccess(itemId, ATTR_OWNER))
                .withGroupAccess(itemFinder.getAccess(itemId, ATTR_GROUP))
                .withOtherAccess(itemFinder.getAccess(itemId, ATTR_OTHER))
                ...
                .withParent(itemFinder.getFolder(rs.getObject(COL_PARENT_ID, UUID.class)));
