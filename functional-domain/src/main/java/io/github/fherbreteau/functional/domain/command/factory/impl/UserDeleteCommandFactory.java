...
import io.github.fherbreteau.functional.domain.command.impl.check.CheckUserDeleteCommand;
...
public class UserDeleteCommandFactory implements UserCommandFactory {
    @Override
