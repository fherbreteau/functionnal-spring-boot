...
import io.github.fherbreteau.functional.domain.command.impl.check.CheckUserModifyCommand;
...
public class UserModifyCommandFactory implements UserCommandFactory {
    @Override
