...
import io.github.fherbreteau.functional.domain.command.impl.check.CheckUserGetCommand;
...
public class UserGetCommandFactory implements UserCommandFactory {
    @Override
    ...
    public CheckCommand<Output> createCommand(UserRepository repository, GroupRepository groupRepository,
        ...
        return new CheckUserGetCommand(repository, groupRepository, userChecker, passwordProtector,
